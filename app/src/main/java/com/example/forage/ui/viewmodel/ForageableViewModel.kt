...
private val forageableDao: ForageableDao
    ...
    val allItems:LiveData<List<Forageable>> = forageableDao.getForagebles().asLiveData()

    // TODO : create method that takes id: Long as a parameter and retrieve a Forageable from the
    //  database by id via the DAO.
    fun retriveItem(id:Long):LiveData<Forageable>{
        return forageableDao.getForageable(id = id).asLiveData()
    }
